...
// Returns the private 'App\Repository\ClueRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ClueRepository.php';

return $this->privates['App\\Repository\\ClueRepository'] = new \App\Repository\ClueRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
