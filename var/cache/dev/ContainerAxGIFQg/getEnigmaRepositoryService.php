...
// Returns the private 'App\Repository\EnigmaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EnigmaRepository.php';

return $this->privates['App\\Repository\\EnigmaRepository'] = new \App\Repository\EnigmaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
