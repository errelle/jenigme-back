...
// Returns the private 'App\Repository\BusinessRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/BusinessRepository.php';

return $this->privates['App\\Repository\\BusinessRepository'] = new \App\Repository\BusinessRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
